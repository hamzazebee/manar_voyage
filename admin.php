...
<main>
    <section>
      ...
      <section>
        <h2>annuler reservation</h2>
        <form id="supprimerReservation" action="supprimerReservation.php"  method="post" >
          <div>
            <label for="idvoyage">ID Voyage :</label>
            <input type="text" id="idvoyage" name="idvoyage" required>
          </div>
      ...
      <section>
        ...
        <form id="Afficher les reservation" action="affichereservation.php"  method="post" >
          <div>
          <button type="submit">afficher les reservation</button>
          </div>
        </form>
      </section>
